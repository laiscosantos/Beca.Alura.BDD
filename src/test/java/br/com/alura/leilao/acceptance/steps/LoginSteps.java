...
public class LoginSteps {
	...
	public void realiza_login() {
       leiloesPage = ((LoginPage) this.loginPage).realizaLoginComo("fulano", "pass");
	...
	public void tenta_se_logar() {
		((LoginPage) this.loginPage).realizaLoginComo("fulano", "xpto");
	}
	
	@Entao("continua na página de login")
	public void continua_na_página_de_login() {
	   Assert.assertTrue(((LoginPage) this.loginPage).estaNaPaginaDeLoginComErro());
	}
